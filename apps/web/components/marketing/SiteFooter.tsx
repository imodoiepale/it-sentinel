    ...
    <footer className="border-t border-white/[0.07]">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-10 sm:flex-row sm:items-center sm:justify-between lg:px-8">
        ...
        <nav aria-label="Footer" className="flex flex-wrap items-center gap-x-6 gap-y-2">
          <Link href="/console" className="text-sm text-gray-400 transition-colors hover:text-white">
            Console
          </Link>
          <Link href="/enroll" className="text-sm text-gray-400 transition-colors hover:text-white">
            Enroll a machine
          </Link>
